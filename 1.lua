...
-- [UPGRADE] New Glowing Wallhack Engine (Bloom Forced ON + 0.05s Timer)
-- ============================================================
...
local function ApplyGlowingWallhack()
    ...
    pcall(function()
        ...
        if gi then
            ...
            gi:ExecuteCMD("r.LightShaftQuality", "2")
        end
    end)
...
-- ============================================================
-- WALLHACK TIMER (runs every 0.05 seconds for ultra smooth glow)
-- ============================================================
